    ...
    <>
      ...
      >
        <ul id="nav-links" className="flex items-center gap-8 list-none m-0 p-0 text-[14px] font-suisse font-medium tracking-[0.16em] text-[rgba(255,255,255,0.88)]">
          ...
          <li>
            <MagneticLink href="/origin" className="px-4 py-2 rounded-full hover:bg-[rgba(255,255,255,0.08)] transition-colors duration-300">
              Products
            </MagneticLink>
          </li>
          <li>
            <MagneticLink href="/about" className="px-4 py-2 rounded-full hover:bg-[rgba(255,255,255,0.08)] transition-colors duration-300 flex items-center gap-1">
              About 
