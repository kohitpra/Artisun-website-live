...
export default function CustomCursor({ mouseProxy }: { mouseProxy: { current: { px: number; py: number } } }) {
  ...
  return (
    <div
      ref={dotRef}
      className="hidden md:block fixed top-0 left-0 w-4 h-4 rounded-full pointer-events-none z-[9999] bg-[var(--brand-cream)] shadow-[0_0_16px_4px_rgba(232,220,200,0.95),0_0_34px_8px_rgba(201,59,26,0.75)]"
